...
import com.junying.day01.Flink02_WordCount_Bounded;
/**
 * Flink01_WordCount_Chain
 *
 * @author King
...
public class Flink01_WordCount_Chain {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple2<String, Integer>> wordToOneDS =
                socketTextStream.flatMap(new Flink02_WordCount_Bounded.LineToTupleFlatMapFunc());
        ...
        //7.启动任务
        env.execute("Flink01_WordCount_Chain");
    }
}
